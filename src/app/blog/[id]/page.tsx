        ...
        <div className="container mx-auto px-6 max-w-4xl space-y-16">
          ...
          {post.content?.map((section: any, idx: number) => {
            ...
            if (section.type === "visual") {
              const visual = blogPosts.find(
                (p) => p.image?.id === section.id
              )?.image
          ...
          {/* Footer */}
          <div className="pt-20 border-t border-white/5 flex justify-between">
            ...
            {blogPosts
              ...
              .map((p) => (
                <Link key={p.id} href={`/blog/${p.id}`}>
                  <GlassCard className="p-6 hover:border-primary/30">
