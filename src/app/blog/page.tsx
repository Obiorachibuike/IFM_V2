...
import { Search, Calendar, Clock, ArrowRight, Filter, Sparkles, BookOpen, ChevronRight } from "lucide-react"
...
export default function BlogPage() {
  ...
  return (
    <div className="flex flex-col w-full min-h-screen bg-background">
      ...
      <section className="relative pt-48 pb-20 overflow-hidden min-h-[50vh] flex items-center border-b border-white/5">
        ...
        <div className="container relative z-10 px-6 max-w-7xl mx-auto">
          ...
          >
            <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-primary/10 border border-primary/20 text-primary text-[10px] font-bold uppercase tracking-[0.2em]">
              <BookOpen className="h-3.5 w-3.5" /> Intelligence Hub
            </div>
      ...
      {/* 2. CATEGORY FILTERS */}
      <section className="sticky top-20 z-40 bg-background/80 backdrop-blur-xl border-b border-white/5 py-4">
      ...
      {featuredPosts.length > 0 && activeCategory === "All" && (
        <section className="py-20 relative overflow-hidden bg-card/5">
          <div className="container mx-auto px-6 max-w-7xl">
            <div className="flex items-center gap-4 mb-12">
              <Sparkles className="h-5 w-5 text-accent" />
              <h2 className="text-2xl font-bold font-headline uppercase tracking-tighter">Flagship <span className="text-accent italic">Intelligence</span></h2>
            </div>
                    ...
                    >
                      ...
                      <div className="p-8 space-y-4 flex-1 flex flex-col justify-between">
                        <div className="space-y-4">
                          <h3 className="text-3xl font-bold font-headline uppercase leading-none tracking-tighter group-hover:text-primary transition-colors">
                            {post.title}
                          </h3>
        ...
        <div className="container mx-auto px-6 max-w-7xl">
                    ...
                    <GlassCard className="group p-0 border-white/5 bg-white/5 h-full flex flex-col hover:border-primary/30">
                      <div className="relative aspect-video overflow-hidden">
                        ...
                        <div className="absolute bottom-4 left-4">
                          <Badge className="bg-black/60 backdrop-blur-md text-[8px] border-white/10 uppercase tracking-widest px-3">
                            {post.category}
                          </Badge>
                        </div>
                      </div>
                      <div className="p-6 space-y-4 flex-1 flex flex-col justify-between">
                        ...
                        <div className="flex items-center justify-between pt-4 border-t border-white/5 text-[10px] text-muted-foreground font-bold uppercase tracking-widest">
          ...
          {filteredPosts.length === 0 && (
            <div className="py-40 text-center space-y-6">
              <div className="text-muted-foreground italic text-xl">No intelligence found matching your current filters.</div>
              <Button onClick={() => { setActiveCategory("All"); setSearchQuery(""); }} variant="outline" className="border-white/10">
                Clear All Filters
              </Button>
            </div>
          )}
      ...
      <section className="py-32 bg-card/10 border-t border-white/5 relative overflow-hidden">
        ...
        <div className="container mx-auto px-6 max-w-4xl text-center space-y-10 relative z-10">
          <h2 className="text-4xl md:text-6xl font-bold font-headline uppercase tracking-tighter">SECURE THE <span className="text-gradient-blue italic">FEED</span></h2>
          ...
          <div className="flex flex-col sm:flex-row gap-3 max-w-lg mx-auto">
            <Input placeholder="gaffer@stadium.club" className="bg-white/5 border-white/10 h-14 rounded-xl" />
