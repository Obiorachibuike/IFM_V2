...
export default function EcosystemPage() {
  ...
  return (
    <div className="flex flex-col w-full min-h-screen bg-[#05070D] font-body selection:bg-primary selection:text-white overflow-x-hidden">
      ...
      <section className="relative min-h-[100vh] md:h-screen w-full flex items-center justify-center overflow-hidden py-16 md:py-0 border-b border-white/5">
        ...
        <div className="container relative z-10 mx-auto px-4 sm:px-6 max-w-7xl">
          <motion.div
            ...
            className="flex flex-col items-center text-center space-y-6 md:space-y-8 lg:space-y-12"
          >
            {/* BADGE */}
            <motion.div variants={fadeIn}>
              <Badge className="bg-white/5 text-white border-white/10 px-4 md:px-10 py-2 md:py-3 uppercase tracking-[0.4em] md:tracking-[0.8em] text-[9px] md:text-[10px] font-bold rounded-full backdrop-blur-xl">
                The Living Universe
              </Badge>
            </motion.div>
            ...
            <motion.h1
              variants={fadeIn}
              className="text-4xl sm:text-6xl md:text-7xl lg:text-[7.5rem] xl:text-[8.5rem] font-bold font-headline tracking-tighter uppercase leading-[0.95] md:leading-[0.9] text-white"
            >
              A WORLD OF <br />
            ...
            <motion.p
              variants={fadeIn}
              className="text-sm sm:text-base md:text-xl lg:text-2xl text-white/80 max-w-3xl mx-auto font-light leading-relaxed px-2 md:px-0"
            >
            ...
            {/* CTA ACTION ENGINE */}
            <motion.div variants={fadeIn} className="flex flex-col sm:flex-row justify-center gap-4 w-full sm:w-auto px-4 sm:px-0 max-w-md sm:max-w-none">
              <Button
                asChild
                size="lg"
                className="h-14 md:h-16 lg:h-20 px-8 lg:px-16 bg-primary hover:bg-primary/90 text-white font-bold rounded-xl lg:rounded-2xl glow-blue text-sm md:text-base lg:text-xl uppercase tracking-widest w-full sm:w-auto transition-all duration-300"
              >
              ...
              <Button
                ...
                size="lg"
                variant="outline"
                className="h-14 md:h-16 lg:h-20 px-8 lg:px-16 border-white/20 hover:bg-white/10 text-white font-bold rounded-xl lg:rounded-2xl text-sm md:text-base lg:text-xl uppercase tracking-widest backdrop-blur-xl w-full sm:w-auto transition-all duration-300"
              >
                <Link href="#loop">
                  VIEW PROTOCOL
                </Link>
            ...
            <motion.div
              variants={fadeIn}
              className="grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-8 lg:gap-12 pt-8 md:pt-12 lg:pt-20 border-t border-white/10 w-full max-w-5xl"
            >
              {[
      ...
      <section id="loop" className="py-16 sm:py-24 md:py-32 lg:py-48 relative overflow-hidden bg-background border-b border-white/[0.02]">
        <div className="container mx-auto px-4 sm:px-6 max-w-7xl">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-24 xl:gap-32 items-center">
            
            <motion.div variants={fadeIn} initial="initial" whileInView="whileInView" className="space-y-6 sm:space-y-8 lg:space-y-12">
              <div>
              ...
              <h2 className="text-3xl sm:text-5xl md:text-6xl font-headline font-bold uppercase tracking-tighter leading-[0.95] sm:leading-[0.9]">THE ENDLESS <br /><span className="text-gradient-gold italic font-extrabold">PROGRESSION.</span></h2>
               ...
               <GlassCard className="p-0 border-white/10 glow-gold overflow-hidden relative aspect-square sm:aspect-video lg:aspect-square w-full rounded-2xl" hoverable={false}>
                  ...
                  <div className="absolute inset-0 flex flex-col justify-end p-6 md:p-10 bg-gradient-to-t from-background via-background/40 to-transparent">
                     <div className="space-y-3 sm:space-y-4">
                        ...
                        <h3 className="text-xl sm:text-3xl font-bold font-headline uppercase leading-none text-white">THE REWARD <br />ENGINE</h3>
                        <p className="text-muted-foreground text-xs font-light max-w-sm leading-relaxed">Watch your club&apos;s valuation grow as you progress through the divisions. Every win is a permanent investment.</p>
                     </div>
                  </div>
      ...
      <section className="py-16 sm:py-24 md:py-32 lg:py-48 relative border-t border-white/5 bg-card/5">
        <div className="container mx-auto px-4 sm:px-6 max-w-7xl">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-24 xl:gap-32 items-center">
            
            <motion.div variants={fadeIn} initial="initial" whileInView="whileInView" className="order-1 lg:order-2 space-y-6 sm:space-y-8 lg:space-y-12">
               <div>
               ...
               <h2 className="text-3xl sm:text-5xl md:text-6xl font-headline font-bold uppercase tracking-tighter leading-[0.95] sm:leading-[0.9]">COMPETITIVE <br /><span className="text-gradient-blue italic font-extrabold">HIERARCHY.</span></h2>
               <p className="text-sm sm:text-base md:text-lg text-muted-foreground font-light leading-relaxed">
      ...
      <section className="py-20 sm:py-32 lg:py-48 xl:py-56 relative text-center overflow-hidden bg-[#03060F]">
        <div className="absolute inset-0 radial-glow-blue opacity-20 pointer-events-none" />
        <div className="container relative z-10 mx-auto px-4 sm:px-6 max-w-5xl space-y-8 sm:space-y-12">
          
          <motion.div variants={fadeIn} initial="initial" whileInView="whileInView" className="space-y-6 sm:space-y-8">
            <h2 className="text-4xl sm:text-6xl md:text-7xl lg:text-8xl xl:text-[9.5rem] font-bold font-headline tracking-tighter uppercase leading-[0.95] sm:leading-[0.9] text-white">
              JOIN THE <br />
              <span className="text-gradient-blue italic font-extrabold">NETWORK.</span>
            </h2>
            
            <div className="flex flex-col sm:flex-row justify-center items-center gap-4 px-4 sm:px-0 max-w-md mx-auto sm:max-w-none">
              <Button 
                asChild 
                size="lg" 
                className="w-full sm:w-auto h-16 md:h-20 px-8 sm:px-16 bg-primary hover:bg-primary/90 text-white font-bold rounded-xl sm:rounded-2xl glow-blue text-sm sm:text-lg uppercase tracking-widest transition-all duration-300"
              >
            ...
            <p className="text-muted-foreground uppercase tracking-[0.2em] sm:tracking-[0.5em] text-[9px] sm:text-[10px] font-bold opacity-60">
