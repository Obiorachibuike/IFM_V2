...
import { Shield, Coins, Database, Layers, ArrowRight, Zap, Trophy, Cpu, Target, BarChart3, Wallet, Rocket } from "lucide-react"
    ...
    <div className="flex flex-col w-full">
      ...
      <section className="relative pt-48 pb-32 overflow-hidden bg-background">
        <div className="absolute inset-0 z-0">
          ...
          <div className="absolute top-0 right-0 w-[800px] h-[600px] bg-primary/10 blur-[150px] rounded-full -mr-40 -mt-40" />
        </div>
        ...
        <div className="container relative z-10 px-6 max-w-7xl mx-auto">
          ...
          >
            <Badge className="bg-accent/10 text-accent border-accent/30 px-6 py-2 uppercase tracking-[0.5em] text-[10px] font-bold">Protocol Infrastructure</Badge>
            ...
            <p className="text-2xl text-secondary-foreground leading-relaxed max-w-3xl font-light">
              IFM represents the convergence of professional football management and decentralized economic infrastructure. Own your assets, control your rewards, and lead the global empire.
            </p>
          </motion.div>
        </div>
      </section>

      {/* 2. HOW TO MINT SECTION */}
      <section className="py-32 relative border-t border-white/5 bg-secondary-background/5">
        <div className="container mx-auto px-6 max-w-7xl">
          <div className="text-center mb-24 space-y-6">
            ...
            <p className="text-xl text-secondary-foreground font-light">Four steps to securing your foundation club license.</p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            {[
              { icon: Wallet, title: "Connect", desc: "Register your manager profile and connect your secure digital wallet." },
              { icon: Shield, title: "Whitelist", desc: "Founding managers with verified early access status receive priority." },
              { icon: Rocket, title: "Mint", desc: "Select your tier and mint your persistent Club License on the blockchain." },
              { icon: Target, title: "Deploy", desc: "Instantly field your squad and begin competing in the Pro League." }
            ].map((step, i) => (
              <div key={i} className="text-center space-y-6 relative group">
                ...
                <h4 className="text-xl font-bold font-headline uppercase tracking-widest">{step.title}</h4>
                <p className="text-sm text-secondary-foreground leading-relaxed font-light">{step.desc}</p>
                {i < 3 && <div className="hidden md:block absolute top-10 left-full w-full h-[1px] bg-gradient-to-r from-accent/40 to-transparent -ml-10 -z-10" />}
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="container mx-auto px-6 max-w-7xl">
          <div className="text-center mb-24 space-y-6">
            <h2 className="text-5xl md:text-7xl font-bold font-headline uppercase tracking-tighter leading-none">
              GENESIS <br /><span className="text-accent italic">PRESTIGE TIERS</span>
            </h2>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            {[
              ...
              <GlassCard key={i} className={cn("p-12 bg-secondary-background/30", tier.color)} glowColor={i >= 2 ? "gold" : "blue"}>
                <div className="flex flex-col md:flex-row justify-between items-start gap-8">
                  <div className="space-y-6 flex-1">
                    ...
                    <ul className="space-y-3">
                      {tier.perks.map((perk, j) => (
                        <li key={j} className="flex items-center gap-3 text-secondary-foreground font-light text-sm">
                  ...
                  <div className="text-right space-y-2">
                    <div className="text-[10px] font-bold text-secondary-foreground uppercase tracking-widest">Protocol Supply</div>
      ...
      {/* 4. TOKEN ECONOMY */}
      <section className="py-48 relative overflow-hidden bg-secondary-background/20">
        <div className="container mx-auto px-6 max-w-7xl">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-24 items-center">
            <div className="space-y-12">
              <div className="space-y-6">
                <Badge className="bg-primary/10 text-primary border-primary/30 px-6 py-2 uppercase tracking-[0.5em] text-[10px] font-bold">Economic Architecture</Badge>
                <h2 className="text-6xl font-bold font-headline uppercase leading-none tracking-tighter">
                  THE <span className="text-primary italic">$IFM TOKEN</span>
                </h2>
                <p className="text-xl text-secondary-foreground font-light leading-relaxed">
                  The $IFM token powers every layer of the ecosystem, from managerial operations to decentralized protocol governance and withdrawable rewards.
                </p>
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                {[
                  ...
                  <GlassCard key={i} className="p-8 border-white/5 bg-background/60">
            ...
            <GlassCard className="p-12 border-white/10" glowColor="blue">
               ...
               <div className="space-y-8">
                  {[
                    { label: "Ecosystem Rewards", value: 35, color: "bg-primary" },
                    { label: "Community & DAO", value: 20, color: "bg-blue-900" },
                    { label: "Strategic Partners", value: 15, color: "bg-accent" },
