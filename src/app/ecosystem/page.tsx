...
import { Shield, Target, Wallet, Rocket, Zap, Trophy, Coins, Cpu, Lock, Globe } from "lucide-react"
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
            ...
            >
              ...
              <GlassCard className="p-0 border-white/10 overflow-hidden glow-blue" hoverable={false}>
                 <Image src="https://picsum.photos/seed/ifm-nft/800/800" alt="NFT Card" width={800} height={800} className="w-full h-auto brightness-75" />
              </GlassCard>
            </motion.div>
          </div>
        </div>
      ...
      <section className="py-32 relative bg-card/10 border-y border-white/5">
        <div className="container mx-auto px-6 max-w-7xl">
          <div className="text-center mb-24 space-y-4">
             <h2 className="text-5xl md:text-7xl font-bold font-headline uppercase tracking-tighter">THE <span className="text-primary italic">$IFM</span> ENGINE</h2>
