  ...
  return (
    <div className="flex flex-col w-full min-h-screen bg-[#05070D] font-body selection:bg-accent selection:text-background">
      ...
      <section className="relative h-[80vh] min-h-[700px] flex items-center overflow-hidden border-b border-white/5">
        ...
        {/* Banner Overlay */}
        <div className="absolute bottom-16 right-16 hidden md:block text-right">
           <h4 className="text-2xl font-bold text-accent uppercase tracking-[0.4em] italic">ECONOMIC PROTOCOL</h4>
           <p className="text-[10px] text-accent/40 uppercase tracking-widest mt-2">Node: Treasury_Alpha_Active</p>
        </div>
      </section>
            ...
            <motion.div variants={fadeIn} initial="initial" whileInView="whileInView">
               <GlassCard className="p-0 border-white/10 glow-blue overflow-hidden relative aspect-square" hoverable={false}>
                  ...
                  <div className="absolute top-12 left-12">
                     <span className="text-[10px] font-bold text-primary uppercase tracking-[0.5em] bg-black/40 px-4 py-2 rounded-full backdrop-blur-md">INTERFACE: UTILITY_LAYER_ACTIVE</span>
                  </div>
               </GlassCard>
            </motion.div>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-32 items-center">
            ...
            <motion.div variants={fadeIn} initial="initial" whileInView="whileInView" className="lg:order-1">
               <GlassCard className="p-0 border-white/10 glow-blue overflow-hidden relative aspect-[4/5]" hoverable={false}>
                  ...
                  <div className="absolute top-12 left-12">
                     <h4 className="text-xl font-bold text-white uppercase tracking-[0.4em]">IFM: PERFORMANCE_YIELD_ENGINE</h4>
                  </div>
               </GlassCard>
            </motion.div>
          </div>
