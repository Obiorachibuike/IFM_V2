...
export default function HomePage() {
  ...
  return (
    <div className="flex flex-col w-full bg-background selection:bg-primary selection:text-white">
      ...
      {/* 1. CINEMATIC BANNER */}
<section className="relative h-screen flex flex-col items-center justify-start overflow-hidden pt-40 md:pt-52">

  <div className="absolute inset-0 z-0">

    {/* Main cinematic overlay (lighter + cleaner) */}
    ...
    {genesisBanner && (
      <Image
        ...
        fill
        priority
        className="object-cover brightness-[0.78] contrast-[1.08] saturate-125 scale-[1.02]"
  ...
  {/* HERO CONTENT */}
  <div className="container relative z-50 mx-auto px-6 text-center -mt-32 md:-mt-40">
