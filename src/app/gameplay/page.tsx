      ...
      <section className="relative min-h-screen w-full flex items-center justify-center overflow-hidden bg-black py-20 md:py-0">
        ...
        <div className="container relative z-10 mx-auto px-4 sm:px-6 max-w-7xl">
          <motion.div
            ...
            className="flex flex-col items-center text-center space-y-6 md:space-y-10 bg-black/30 backdrop-blur-md py-8 md:py-12 rounded-3xl border border-white/5 shadow-2xl max-w-5xl mx-auto px-4 sm:px-8"
          >
            {/* BADGE */}
            ...
            <motion.h1
              variants={fadeIn}
              className="text-4xl sm:text-6xl md:text-7xl lg:text-[7.5rem] font-bold font-headline tracking-tighter uppercase leading-[0.95] md:leading-[0.9] text-white drop-shadow-[0_4px_12px_rgba(0,0,0,0.8)]"
            >
              LEARN TO <br />
            ...
            <motion.p
              variants={fadeIn}
              className="text-xs sm:text-sm md:text-xl text-white/70 max-w-3xl mx-auto font-light leading-relaxed px-2 sm:px-4 drop-shadow-md"
            >
